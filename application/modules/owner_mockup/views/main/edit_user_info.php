<div class="page-content-wrapper">
                        <!-- BEGIN CONTENT BODY -->
                        <div class="page-content" style="min-height:472px padding: 15px 0 10px;padding-top: 25;">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <div class="input-field">
                                                                                    <input id="us-name" type="text" class="validate" value="priusIV" name="data[username]" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">

                                                                                    <label for="us-name" class="control-label active">User Name                                                                                        <span class="required"> * </span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <div class="input-field">
                                                                                    ...
                                                                                    <label data-error="wrong" data-success="right" for="us-pass-conf" class="control-label">Confirm Password                                                                                        <span class="required"> * </span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <div class="input-field">
                                                                                    ...
                                                                                    <label for="us-fr-nm" class="control-label active">First Name                                                                                        <span class="required"> * </span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <div class="input-field">
                                                                                    ...
                                                                                    <label for="us-fr-nm" class="control-label active">Last Name                                                                                        <span class="required"> * </span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-group input-field">
                                                                                <div class="col-md-6" style="padding-left: 0">
                                                                                    <table>
                                                                                        <tbody><tr>
                                                                                            <td style="width: 98%">
                                                                                                <input type="text" id="us_phone" value="4445556666" name="data[phone]" class="form-control required_form " maxlength="50" onchange="javascript:checkPhonesVisibilty(); validateFormEnableOrDisable('form_client_edit');" "="">
                                                                                                <label for="us_phone" class="active">Phone<span class="required">&nbsp;*&nbsp;</span></label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody></table>
                                                                                </div><!-- ./col -->
                                                    ...
                                                    <div class="col-xs-12 text-center sev-canc-mock">
                                                        <button class="btn"><a href="/sys-admin/users/users-overview/42" style="color: #fff;"> CANCEL</a></button>
