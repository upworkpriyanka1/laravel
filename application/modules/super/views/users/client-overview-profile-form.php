                ...
                <li class="nav-item">
                    ...
                    <div class="collapsible-body" >
                        <ul>
                            <!-- SIDEBAR MENU LINK -->
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>super/contacts-view" class="nav-link ">
                                    <!-- <a href="--><!--" class="nav-link ">-->
                                    <span class="fa fa-folder-open"></span>
                                    <span class="title">View Contacts</span>
                                </a>
                            </li>
                            ...
                            <!-- SIDEBAR MENU LINK -->
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>super/contacts-add"   class="nav-link ">
                                    <!-- <a href="--><!--" class="nav-link ">-->
                ...
                <li class="nav-item">
                    ...
                    <div class="collapsible-body" >
                        <ul>
                            <!-- SIDEBAR MENU LINK -->
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>super/profile" class="nav-link ">
                                    <!-- <a href="--><!--" class="nav-link ">-->
                            ...
                            <!-- SIDEBAR MENU LINK -->
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>super/profile-company" class="nav-link ">
                                    <!--<a href="--><!--" class="nav-link ">-->
                                    <span class="fa fa-pencil-square"></span>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapsible-body" >
                        <ul>
                            <!-- SIDEBAR MENU LINK -->
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>super/activity-logs" class="nav-link ">
                                    <!--<a href="--><!--" class="nav-link ">-->
