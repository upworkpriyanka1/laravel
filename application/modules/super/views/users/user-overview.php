        ...
        <div>
            ...
            <?php } ?>
                ...
                <div class="user-st stat">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" disabled><span class="status_but_name"><?=$user_status;?></span><span class="caret"></span></button>
...
<!--                </div>
			...
			<div id="grid-pinned" class="scrollspy">
                ...
                <div class="row">
				 ...
				 <div class="schedule">
                 <img src="/zntral/assets/img/calendar-img.jpg" alt="Calendar Image" width="100%";/>
				 </div>
                 </div>
                </div>
			 </div>	
