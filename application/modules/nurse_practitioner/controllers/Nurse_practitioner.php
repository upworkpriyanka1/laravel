...
class Nurse_practitioner extends CI_Controller {
	public function __construct() {
	   parent::__construct();

	   $job = array('nurse-practitioner');
	/*check if logged in */
	...
	/* load library & model with aliases, config and language */
			$this->load->library('Nurse_practitioner_lib',NULL, 'nurse_lib');
			$this->load->model('nurse_practitioner_mdl','nurse_mdl');
			$this->lang->load('nurse_practitioner');
			$this->config->load('nurse_practitioner_menu', true );
			$this->menu    			= $this->config->item( 'nurse_practitioner_menu' );
