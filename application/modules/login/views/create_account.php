	...
	<script type="text/javascript">	
		$(document).ready(function(){
			...
			$('#step1 .collection a').click(function(){				
				...
				/*$('#step1 .collection a').each(function () { 
...
<main>
	<div class=" logo">
		<a href="index.html"><img src="<?php echo base_url() ?>assets/img/logo.png" alt="" style="backgro" /></a>
	</div>
...
<style> .login{background-color: none !important;}</style>
</body>
</html>
