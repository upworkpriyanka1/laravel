		...
		<div class="portlet light bordered">
			<div class="portlet-body">
				...
				<div class="table-toolbar table_info">
					...
					<button type="button" class="btn btn-filter btn-default btn-sm pull_right_only_on_xs padding_right_sm tooltipped" onclick="javascript:vendorTypesListFilterApplied();" data-position="top" data-tooltip="Open dialog window to set filter for vendor types. <?= ( trim($filters_label) != "" ? "Current filter(s):".$filters_label : "") ?>" data-original-title="Open dialog window to set filter for vendor types. <?= ( trim($filters_label) != "" ? "Current filter(s):".$filters_label : "") ?>"><i class="glyphicon glyphicon-filter"></i>&nbsp;Filter </button>
					<button type="button" class="btn btn-plus btn-sm pull-right" onclick="javascript:document.location='<?= base_url() ?>sys-admin/vendors/vendor-types-edit/new<?=$page_parameters_with_sort ?>'" ><i class="glyphicon glyphicon-plus"></i></button>
