		...
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet light portlet-fit portlet-form bordered">
				...
				<div class="portlet-body">
					<!-- BEGIN FORM-->
					<form action="<?php echo base_url() ;?>sys-admin/client/<?= ( $is_insert ? "new" : $cid ) ?><?= $page_parameters_with_sort ?>" method="post" id="form_client_edit" name="form_client_edit" class="form-horizontal"  enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group input-field <?= $this->common_lib->set_field_error_tag("data[client_state]", ' has-error ')?> <?= $this->common_lib->set_field_error_tag("data[client_city]", ' has-error ')?> <?= $this->common_lib->set_field_error_tag("data[client_zip]", ' has-error ')?> ">
										...
										?>
										<div class="col-md-1" style="display: <?php echo ( $client_city_button_visible ? "block" :"none") ; ?>" id="div_client_city_btn">
										...
										<div class="col-md-1"  style="display: <?php echo ( $client_city_input_visible ? "block" :"none" ) ; ?>" id="div_client_city_input">
										...
										<div class="col-md-1"  style="display: <?php echo ( ( $client_city_view_visible ) ? "block" :"none" ) ; ?>" id="div_client_city_view">
										...
										?>
										<div class="col-md-1" style="display: <?php echo ( $client_state_button_visible ? "block" :"none") ; ?>" id="div_client_state_btn">
										...
										<div class="col-md-1" style="display: <?php echo ( $client_state_input_visible ? "block" :"none" ) ; ?>" id="div_client_state_input">
										...
										<div class="col-md-1" style="display: <?php echo ( ( $client_state_view_visible ) ? "block" :"none" ) ; ?>" id="div_client_state_view">
										...
										?>
										<div class="col-md-1" style="display: <?php echo ( $client_zip_button_visible ? "block" :"none") ; ?>" id="div_client_zip_btn">
										...
										<div class="col-md-1"  style="display: <?php echo ( $client_zip_input_visible ? "block" :"none" ) ; ?>" id="div_client_zip_input">
										...
										<div class="col-md-1" style="display: <?php echo ( ( $client_zip_view_visible ) ? "block" :"none" ) ; ?>" id="div_client_zip_view">
