                                        ...
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                <div class="form-group input-field padding_lg <?= $this->common_lib->set_field_error_tag("data[client_img]", ' has-error ')?>">
                                                    ...
                                                    <div class="col-md-12" style="display: <?php echo ( $is_insert ? "block" :"none") ; ?>" id="div_client_img_btn">
                                                    ...
                                                    <div class="col-md-12" id="div_client_img_view">
                                                    ...
                                                    <div class="col-md-12" style="display: none" id="div_client_img_input">
