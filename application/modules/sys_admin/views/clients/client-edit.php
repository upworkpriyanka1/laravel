...
<!--						<input type="hidden" id="filter_client_active_status" name="filter_client_active_status" value="--><?//=$filter_client_active_status?><!--">-->
						...
						<div class="form-body">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-4"><?php echo lang('cid');?>
											</label>
											<div class="col-md-7">
							...
							<div class="row">
								<!-- Client  client_name -->
								<div class="col-md-6">
									<div class="form-group <?= $this->common_lib->set_field_error_tag("data[client_name]", ' has-error ')?> ">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group <?= $this->common_lib->set_field_error_tag("data[client_active_status]", ' has-error ')?>">
							...
							<div class="row">
								<!-- client Addrtess 1 -->
								<div class="col-md-6">
									<div class="form-group <?= $this->common_lib->set_field_error_tag("data[client_address1]", ' has-error ')?>">
										<label class="control-label col-md-4"><?php echo lang('address1') ?>
											<span class="required"> * </span>
										</label>
										<div class="col-md-7">
											<input type="text" name="data[client_address1]" value="<?= ( !empty($client->client_address1) ? $client->client_address1 : '' ); ?>" class="form-control" maxlength="100" />
										</div><!-- ./col -->
									</div><!-- ./form-group -->
								</div><!-- ./col -->
								<!-- client Address 2 -->
								<div class="col-md-6">
									<div class="form-group <?= $this->common_lib->set_field_error_tag("data[client_address2]", ' has-error ')?>">
										<label class="control-label col-md-4"><?php echo lang('address2') ?>
										</label>
										<div class="col-md-7">
											<input type="text" name="data[client_address2]" value="<?= ( !empty($client->client_address2) ? $client->client_address2 : '' ); ?>"  class="form-control" maxlength="100" />
										</div><!-- ./col -->
									</div> <!-- ./form-group -->
								</div><!-- ./col -->
							</div> <!-- ./row -->
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group <?= $this->common_lib->set_field_error_tag("data[client_state]", ' has-error ')?> <?= $this->common_lib->set_field_error_tag("data[client_city]", ' has-error ')?> <?= $this->common_lib->set_field_error_tag("data[client_zip]", ' has-error ')?> ">
										<label class="control-label col-md-2"><?php echo lang('city') ?>/<?php echo lang('state') ?>/<?php echo lang('zip') ?>
											<span class="required"> * </span>
										</label>
										<div class="col-md-1">
											<input type="text" name="data[client_city]" value="<?= ( !empty($client->client_city) ? $client->client_city : '' ); ?>" class="form-control" maxlength="100" />
										</div><!-- ./col -->
										<div class="col-md-1">
											<input type="text" name="data[client_state]" value="<?= ( !empty($client->client_state) ? $client->client_state : '' ); ?>" class="form-control" maxlength="50" />
										</div><!-- ./col -->
										<div class="col-md-1">
											<input type="text" name="data[client_zip]" value="<?= ( !empty($client->client_zip) ? $client->client_zip : '' ); ?>" class="form-control" maxlength="50" />
										</div><!-- ./col -->
									</div><!-- ./form-group -->
								</div><!-- ./col -->
								<!-- client state -->
							...
							<div class="row" >
								<div class="col-md-6 ">
									<div class="form-group padding_lg <?= $this->common_lib->set_field_error_tag("data[client_img]", ' has-error ')?>">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" value="<?= ( !empty($client->created_at) ? $ci->common_lib->format_datetime( $client->created_at ) : '' ) ?>" class="form-control" disabled />
											</div><!-- ./col -->
										</div><!-- ./form-group -->
									</div><!-- ./col -->
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" value="<?= ( !empty($client->updated_at) ? $ci->common_lib->format_datetime( $client->updated_at ) : '' ) ?>" class="form-control" disabled />
											</div><!-- ./col -->
										</div><!-- ./form-group -->
									</div><!-- ./col -->
								</div><!-- ./col -->
