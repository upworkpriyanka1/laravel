        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                ...
                <?php /*?><div class="table-toolbar table_info">
                	<h4>
					<?php if ( count($users) > 0 ) { ?>
						<?= count($users); ?>&nbsp;Row<?php if ( count($users) > 1 ) { ?>s<?php } ?>&nbsp;of&nbsp;<?= $RowsInTable ?>&nbsp;(Page # <strong><?= $page_number ?> </strong>)
					<?php } ?>
					</h4>
                            ...
                            <?php if (isset($users) && count($users) > 0) {
                                ...
                                foreach ($users as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $this->common_lib->groupItems($row->user_group_description, ',', ''); ?></a>
                                        </td>
