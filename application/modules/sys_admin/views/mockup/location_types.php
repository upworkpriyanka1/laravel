		...
		<div class="portlet light bordered">
			<div class="portlet-body">
                ...
                <div class="table-toolbar table_info">
                   <h4>7&nbsp;Rows&nbsp;of&nbsp;&nbsp;(Page # <strong> </strong>)</h4>
				...
				<div class="table-responsive">
					...
					<tbody>
						<tr>
							<td>adult_day_care</td>
							<td>10</td>
							<td>Adult Day Care <a href="#" class="icon-type-pen" data-toggle="modal" data-target="#edit-clients-type"><i class="material-icons">edit</i></a></td>
						</tr>
					<tr>
						<td>senior_assisted_living</td>
						<td>12</td>
						<td>Assisted /Senior Living Facilities <a href="#" class="icon-type-pen" data-toggle="modal" data-target="#edit-clients-type"><i class="material-icons">edit</i></a></td>
					</tr>
					<tr>
						<td>home_health</td>
						<td>13</td>
						<td>Home Health <a href="#" class="icon-type-pen" data-toggle="modal" data-target="#edit-clients-type"><i class="material-icons">edit</i></a></td>
					</tr>
