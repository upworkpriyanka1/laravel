    ...
    <div class="toc-wrapper pin-top" style="top: 140px; position:fixed;">
            ...
            <div id="carbonads">
                <span>
                    <!--<span class="carbon-wrap">
                        <a href="//srv.carbonads.net/ads/click/x/GTND423YCYAIK2Q7CVS4YKQWFTSITK3ECTBD4Z3JCEADK537F6SICKQKC6BDE2J7CYBIKK3EHJNCLSIZZRLCP7I35MNFV?segment=placement:materializecss;&amp;encredirect=http%3A%2F%2Fwww.launchbit.com%2Ftaz%2F9533-6496-111%2F" class="carbon-img" target="_blank">
                            <img src="https://launchbit.com/carbon-i/6496-ZenHubCarbon.png" alt="" border="0" height="100" width="130" style="max-width: 130px;">
                        </a>
                        <a href="//srv.carbonads.net/ads/click/x/GTND423YCYAIK2Q7CVS4YKQWFTSITK3ECTBD4Z3JCEADK537F6SICKQKC6BDE2J7CYBIKK3EHJNCLSIZZRLCP7I35MNFV?segment=placement:materializecss;&amp;encredirect=http%3A%2F%2Fwww.launchbit.com%2Ftaz%2F9533-6496-111%2F" class="carbon-text" target="_blank">Stop wasting hours in JIRA! Get epics, task boards, and more inside GitHub.
                        </a>-->
                    </span>
                    <a href="http://carbonads.net/" class="carbon-poweredby" target="_blank">ads via Carbon</a>
                    <img src="https://www.launchbit.com/carbon-pixel/9533-6496-111/" border="0" height="1" width="1" style="display: none;">
                </span>
            </div>
        </div>
        <div style="height: 1px;">
            <ul class="section table-of-contents">
                ...
                <li><a href="#grid-push" class="">Push and Pull</a></li>
...
<script>
    $(window).scroll(function (event) {
        ...
        var grid_container = $('#grid-container').offset().top - 300;
        var grid_intro = $('#grid-intro').offset().top - 300;
        var grid_offsets = $('#grid-offsets').offset().top - 300;
        var grid_push = $('#grid-push').offset().top - 300;
        var grid_layouts = $('#grid-layouts').offset().top - 300;
...
//        console.log(scroll+' - '+width+" - "+grid_responsive);
        ...
        }else if(scroll >= grid_layouts) {
            $('.table-of-contents li a').removeClass('active');
            $('.table-of-contents li a[href="#grid-layouts"]').addClass('active');
        }else if(scroll >= grid_push) {
            $('.table-of-contents li a').removeClass('active');
            $('.table-of-contents li a[href="#grid-push"]').addClass('active');
        }else if(scroll >= grid_offsets) {
            $('.table-of-contents li a').removeClass('active');
            $('.table-of-contents li a[href="#grid-offsets"]').addClass('active');
        }else if(scroll >= grid_intro) {
            $('.table-of-contents li a').removeClass('active');
            $('.table-of-contents li a[href="#grid-intro"]').addClass('active');
        }else {
            $('.table-of-contents li a').removeClass('active');
            $('.table-of-contents li a[href="#grid-container"]').addClass('active');
        }
