As I do not have access to dev site, I wrote http://SERVER-NAME.com/ host name.
It must be replaced with real size.

////////////////////////// Get List of clients ////////////////////////
all clients
http://SERVER-NAME.com/sys-admin/api/clients/clients
Additive parameters
...
example:
http://SERVER-NAME.com/sys-admin/api/clients/clients/show_client_type_description/1/filter_client_name/prop
...
example:
http://SERVER-NAME.com/sys-admin/api/clients/clients/show_client_type_description/1/filter_client_active_status/A
...
example:
http://SERVER-NAME.com/sys-admin/api/clients/clients/filter_client_active_status/A/filter_client_type/4
...
example:
http://SERVER-NAME.com/sys-admin/api/clients/clients/show_client_type_description/1/filter_client_active_status/A/filter_client_zip/1234
...
example:
http://SERVER-NAME.com/sys-admin/api/clients/clients/filter_client_active_status/A/sort/client_owner/sort_direction/desc
...
Example :
http://SERVER-NAME.com/sys-admin/api/clients/clients/show_client_type_description/1/filter_client_name/Zerda
...
http://SERVER-NAME.com/sys-admin/api/clients/clients/id/14
In case of request returned row code 200 is returned.


In case of request returned no rows code 404 is returned.
Example :
http://SERVER-NAME.com/sys-admin/api/clients/clients/id/14765


////////////////////////// Adding of client by POST ////////////////////////
http://SERVER-NAME.com/sys-admin/api_testing/client_post
...
all clients types
http://SERVER-NAME.com/sys-admin//api/clients/clients_types

http://SERVER-NAME.com/sys-admin/api/clients/clients_types/filter_type_name/a/sort_direction/desc/
