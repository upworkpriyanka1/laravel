...
//		$this->load->view('users/user-overview-page');
    ...
    public function users_view()
    {
        ...
        $filters_label_array = array('search' => $this->input->get("search"), 'username' => $filter_username, 'user_status' => $this->common_lib->get_user_status_label($filter_user_status), 'zip' => $filter_zip, 'filter_user_group_id' => $filter_user_group_id, 'created at from' => $filter_created_at_from, 'created at till' => $filter_created_at_till);
