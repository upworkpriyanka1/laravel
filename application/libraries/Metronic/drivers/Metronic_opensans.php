...
class Metronic_opensans extends CI_Driver {
    ...
    */
	public function opensans($type=NULL)
	{
		// CSS Files(s)
		if ($type == 'css') {
			$this->CI->output->append_output(
				link_tag('//fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all')
			);
		}
