...
$config['site_title']                 = "Xntral";       // Site Title, example.com

$config['admin_email']                = "reg@xntral.net"; // Admin Email, admin@example.com

$config['default_group']              = 'user';           // Default group, use name

$config['admin_group']                = 'sys-admin';             // Default administrators group, use name
...
$config['activation_link_expiration'] = 2;
